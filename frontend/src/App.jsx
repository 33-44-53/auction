      ...
      <header className="glass-dark text-white shadow-2xl relative z-10">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              {isDark ? (
                <>
                  ...
                  <span className="text-yellow-300 font-semibold">☀️ Light</span>
                </>
              ) : (
                <>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-indigo-300 font-semibold">🌙 Dark</span>
                </>
              )}
            </button>
            <a
              href="/profile"
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 px-4 py-2 rounded-lg transition cursor-pointer shadow-lg hover:shadow-xl transform hover:scale-105"
              title="View Profile"
            >
              <div className="flex items-center space-x-2">
                ...
                <div className="text-left">
                  ...
                  <div className={`text-xs font-semibold leading-tight ${
                    user?.role === 'ADMIN' ? 'text-yellow-200' :
                    user?.role === 'STAFF' ? 'text-green-200' :
                    'text-blue-200'
                  }`}>
            ...
            <button
              onClick={logout}
              className="bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 px-4 py-2 rounded-lg transition text-sm font-bold text-white shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              🚪 Logout
            </button>
          </div>
