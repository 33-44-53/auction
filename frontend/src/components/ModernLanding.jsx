          ...
          >
            {[
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-white/20 text-center group hover:shadow-2xl transition-all"
              >
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-white/20 hover:shadow-2xl transition-all overflow-hidden"
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-5 transition-opacity`}></div>
                
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all shadow-lg`}>
      ...
      <section className="py-20 px-6 relative">
        <div className="container mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            variants={staggerContainer}
            className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-[3rem] p-12 md:p-16 shadow-2xl relative overflow-hidden"
          >
